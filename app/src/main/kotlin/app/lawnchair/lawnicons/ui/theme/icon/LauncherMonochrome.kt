...
val LawnIcons.LauncherMonochrome: ImageVector
    get() {
        if (_LauncherMonochrome != null) {
            return _LauncherMonochrome!!
        }
        _LauncherMonochrome = ImageVector.Builder(
...
private var _LauncherMonochrome: ImageVector? = null
