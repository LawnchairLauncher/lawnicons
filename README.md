...
This is port of Lawnicons [Lawnicons](https://github.com/LawnchairLauncher/lawnicons) to support motorola launcher.

for other issues or contributing go to official lawnicons repo.
