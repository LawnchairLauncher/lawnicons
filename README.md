...
## Contributing
> [!TIP]
> Starting on August 1, [x9136](https://github.com/x9136) will add as many new icons every month as all the other contributors will add by the end of the month. The first time will be by the end of August.
