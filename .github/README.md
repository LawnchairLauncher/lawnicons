...
For users familiar with the guidelines, checkout how to use (icontool.py)[https://github.com/LawnchairLauncher/lawnicons/blob/develop/.github/icontool_guide.md] to speedup the process of adding icons.
